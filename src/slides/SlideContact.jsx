...
export default function SlideContact() {
  return (
    <Slide
      bg={`
        radial-gradient(ellipse at 30% 40%, ${C.deepPlum} 0%, transparent 60%),
        radial-gradient(ellipse at 70% 70%, ${C.magenta}20 0%, transparent 40%),
        ${C.dark}
      `}
    >
      {/* Grain */}
        ...
        <Stagger delay={0.7}>
          <motion.div
            ...
            style={{
              ...
              cursor: "pointer",
              fontFamily: FONT_BODY,
              boxShadow: `0 8px 32px ${C.magenta}30`,
            }}
          >
            hello@caresyndicate.co.uk
          </motion.div>
        </Stagger>
