...
export default function SlideCrisis() {
  ...
  return (
    <Slide
      bg={`
        radial-gradient(ellipse at 70% 30%, ${C.magenta}12 0%, transparent 50%),
        ${C.dark}
      `}
    >
          ...
          {crisisCards.map((c, i) => (
            ...
            >
              ...
              >
                ...
                />
                <div style={{ fontSize: 14, fontWeight: 600, color: C.cream, marginBottom: 6, fontFamily: FONT_BODY }}>
                  {c.title}
                </div>
                <div
                  style={{
                ...
                <div style={{ fontSize: 13, color: `${C.cream}77`, lineHeight: 1.55, fontFamily: FONT_BODY }}>
